package com.gruposancorseguros.portalclientes.personAPI;
...
public class GetPersonById {
    ...
    @Test
    public void requestGetPersonById(){
        ...
        RestAssured
                ...
                .queryParams("bupId","550351","origenCode","13","aplicationCode","17")
                ...
                .when()
                .get("https://portalclientes-tst0-api.gruposancorseguros.com/api/v2/person/individuals")
                .then()
                .log().all();
    }
